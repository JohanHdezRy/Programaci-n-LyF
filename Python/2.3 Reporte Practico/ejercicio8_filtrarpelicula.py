...
Cali_mayor = list(filter(lambda pelicula:float(pelicula ["CalificaciónIMDB"])>= 8.0,L_peliculas))

nueva_lis = list(map(lambda pelicula: {"titulo": pelicula["Titulo"],"calificacion": pelicula["CalificaciónIMDB"]},Cali_mayor))
print(Cali_mayor)
print(nueva_lis)
