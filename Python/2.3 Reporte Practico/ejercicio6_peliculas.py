...
#usando For
calificaionesFor = [{"Titulo": pelicula["Titulo"],"calificacion": pelicula["CalificaciónIMDB"]} for pelicula in L_peliculas]

#usando Map
calificaionesMap = list(map (lambda pelicula: {"titulo": pelicula["Titulo"],"calificaion": pelicula["CalificaciónIMDB"]},L_peliculas))

print(calificaionesFor)
print(calificaionesMap)